...
class ActsAsDesignTest < ActiveSupport::TestCase
#  def setup
...
#  end
  ...
  def test_should_accesses_blocks_through_boxes
    user = DesignTestModel.create!(:name => 'A test user')
  ...
  def test_should_provide_list_of_displayable_blocks
    ...
    user = DesignTestModel.create!(:name => 'A test user', :template => 'test_2_boxes')
